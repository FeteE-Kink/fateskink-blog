...
func (form *Form) GetAttribute(code string) formAttributes.FieldAttributeInterface {
	idx := slices.IndexFunc(
		form.Attributes,
		func(a formAttributes.FieldAttributeInterface) bool { return a.GetCode() == code },
	)
...
func (form *Form) NestedDerectItemFieldKey(wrapperFieldKey string, index int) string {
